---
title: "Simulation Study I -- High Correlation"
...
We conduct a simulation study to evaluate the performance of our proposed method. 
We create 5 correlated response variables, we then run 1000 simulations on all three methods using 1000 different seeds and collected the p-values from each simulation.
...
png(file='high_corr_pca_eigen.png')
screeplot(pc)
dev.off()


png(file='high_corr_pca_var.png')
...
ggplot(data=pc_load1, aes(x=x, y=b)) + geom_point(cex=3) + ylab("Loading") +   
  xlab('Variables')+
