---
title: "Simulation Study III -- No Effect"
...
This is similar to Simulation II, but this time, we set beta to zero so the gene will not be associated with the outcome variables. 
...
for (j in 1:length(sample_sizes)) {
  ...
  for (i in 1:nsim) {
    ...
    p_values_irma[i, ] <- p.adjust(p_values_irm[i, ], method='holm')
...
matrix_data[, seq(2, 10, 2)] %>% kableExtra::kable()
...
# Plot using ggplot2
png(file='null_type_1_error.png')
